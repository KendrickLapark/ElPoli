...
public class Vegeta extends Actor {
    ...
    public Vegeta( World m) {
        ...
        sprite.setBounds(4, 4,anchuraSprite, alturaSprite); //La posición inicial también debe estar en metros
    ...
    public void draw(Batch batch, float parentAlpha) {
        ...
        //RECORDAR QUE ESTO LO TOCA POR PONER EL MISMO DRAW QUE EL DEL OBJETO, FUNCIONA IGUAL SIN EL SPRITE!=NULL
        if(sprite!=null) {
